...
| [Safe Tenant-Wide Exchange Calendar Cleanup](03-exchange-calendar-cleanup.md) | Removing a stale forwarded meeting invite from calendars tenant-wide: discover → export → human approval → controlled execution |
